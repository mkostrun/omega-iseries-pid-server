...
If the built-in function is used then the ramp/soak of the PID would not be affected,
while if the telnet client is used the PID would end up being stuck on the last sp1 command
